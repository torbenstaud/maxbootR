...
or from the official [CRAN](https://cran.r-project.org/web/packages/maxbootR/index.html) repository in `R` with:
...
For a full tutorial with real-world case studies (finance & climate), check out the [vignette](CRAN) included in the package.
